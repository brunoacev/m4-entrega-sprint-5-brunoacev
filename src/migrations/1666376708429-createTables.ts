...
export class createTables1666376708429 implements MigrationInterface {
    name = 'createTables1666376708429'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "categories" ADD "name" character varying(128) NOT NULL`);
